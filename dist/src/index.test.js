...
describe("testing proxy", () => {
    ...
    test("should return GET response from upstream using uri", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test("should return GET response from upstream", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield app.inject({
            headers: {
    ...
    test("should return POST response from upstream", (done) => {
        return app.inject({
            ...
            if (response) {
                expect(JSON.parse(response.body).data).toBe(JSON.stringify({ hello: "world" }));
            }
            done(err);
        });
    });
